...
class Motivations {
  ...
  Motivations(this.id, this.name, this.image, this.info, this.tag, this.status, this.permissions, this.date, this.isDeleted);

  Motivations.fromJson(Map<String, dynamic> json) {
